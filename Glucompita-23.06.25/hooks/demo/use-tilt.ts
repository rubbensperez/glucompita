...
export default function useTilt({
  ...
  // FIX: Changed NodeJS.Timeout to ReturnType<typeof setTimeout> | undefined
  ...
  }, [maxAngle, isActive, targetAngle]); // Added targetAngle to dependencies as it's used in the effect
